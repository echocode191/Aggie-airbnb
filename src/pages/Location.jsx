...
const Location = () => {
  ...
  const locations = [
    {
      id: 1,
      name: "Bismack Whitehouse Nakuru",
      coords: { lat: -0.3031, lng: 36.0686 },
      description: "Your home away from home with breathtaking mountain views",
      address: "Mountain View Area, Nakuru",
    },
    {
      id: 2,
      name: "Nakuru Town Pickup Point",
      coords: { lat: -0.2831, lng: 36.0632 },
      description: "Convenient pickup location in Nakuru Town",
      address: "Nakuru Town Center",
    },
  ];
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{ 
            ...
            Find your way to our beautiful property with breathtaking mountain views in Nakuru
          </p>
        </div>
        ...
        <div style={{ 
          ...
          <p style={{ 
            ...
            Our property is conveniently located close to Nakuru Town with breathtaking mountain views. 
            We can arrange airport transfers from Nairobi upon request.
          </p>
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <a
              href="https://wa.me/254727012403?text=Hi! I need information about airport transfers."
              target="_blank"
